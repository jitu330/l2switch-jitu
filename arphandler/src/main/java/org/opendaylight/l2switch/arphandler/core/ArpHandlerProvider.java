...
public class ArpHandlerProvider {
    ...
    public void init() {
            ...
            LOG.info("JITU: inside ArpHandler init - flood flow mode is {}", arpHandlerConfig.isIsProactiveFloodMode());

	if(arpHandlerConfig.isIsProactiveFloodMode()) {
            
            LOG.info("JITU: inside ArpHandler init - arpHandlerConfig.isIsProactiveFloodMode");
	    ...
	    //Setup proactive flow writer, which writes flood flows
            ...
            LOG.info("JITU: inside ArpHandler init - else part");

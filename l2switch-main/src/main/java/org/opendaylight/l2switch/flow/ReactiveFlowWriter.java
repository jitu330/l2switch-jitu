...
public class ReactiveFlowWriter implements ArpPacketListener {
    ...
    //Added by Jitu
    private static final Logger LOG = LoggerFactory.getLogger(ReactiveFlowWriter.class);
    ...
    public void onArpPacketReceived(ArpPacketReceived packetReceived) {
	    ...
	    //Added by Jitu 
	    LOG.info("CustomLog: ReactiveFlowWriter: onArpPacketReceived: disabling writeFlows"); 
	    //Commented by Jitu

 ...
 * <i>base-packet/packet-chain-grp/packet-chain</i>
 *
 * <p>To create instances of this class use {@link org.opendaylight.yang.gen.v1.urn.opendaylight.packet.basepacket.rev140528.packet.chain.grp.PacketChainBuilder}.
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.packet.basepacket.rev140528.packet.chain.grp.PacketChainBuilder
 *
 *
 */
public interface PacketChain
    extends
    ChildOf<PacketChainGrp>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.packet.basepacket.rev140528.packet.chain.grp.PacketChain>
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:packet:basepacket",
        "2014-05-28", "packet-chain").intern();

    /**
     * @return <code>org.opendaylight.yang.gen.v1.urn.opendaylight.packet.basepacket.rev140528.packet.chain.grp.packet.chain.Packet</code> <code>packet</code>, or <code>null</code> if not present
     */
    Packet getPacket();

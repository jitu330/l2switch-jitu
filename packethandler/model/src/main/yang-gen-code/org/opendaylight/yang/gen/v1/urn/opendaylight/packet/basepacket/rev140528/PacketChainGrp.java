 ...
 * <i>base-packet/packet-chain-grp</i>
 *
 */
public interface PacketChainGrp
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:packet:basepacket",
        "2014-05-28", "packet-chain-grp").intern();

    /**
     * @return <code>java.util.List</code> <code>packetChain</code>, or <code>null</code> if not present
     */
    List<PacketChain> getPacketChain();
